...
$route['quitar_parcela/(:num)/(:num)/(:num)/(:num)'] = 'venda/quitar_parcela/$1/$2/$3/$4';
$route['deletar_venda/(:num)'] = 'venda/delete/$1';
$route['deletar_peca/(:num)'] = 'estoque/delete/$1';
$route['alterar_peca/(:num)'] = 'estoque/form_altera/$1';
$route['carregar_foto/(:num)'] = 'estoque/form_foto/$1';
$route['deletar_foto/(:num)'] = 'estoque/delete_foto/$1';
...
$route['registrar_reserva'] = 'reserva/resgistrar_reserva';
$route['reserva_vender/(:num)/(:num)'] = 'venda/cadastrar_venda/$1/$2';
$route['cancelar_reserva/(:num)/(:num)'] = 'reserva/cancelar_reserva/$1/$2';
