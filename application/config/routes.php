...
$route['deletar_cliente'] = 'cliente/delete/$1';
$route['alterar_cliente'] = 'cliente/form_altera/$1';
$route['listar_fornecedores'] = 'fornecedor/listar_fornecedor';
$route['cadastrar_fornecedores'] = 'fornecedor/cadastrar_fornecedor';
$route['alterar_fornecedeor/(:num)'] = 'fornecedor/form_altera/$1';
$route['deletar_fornecedeor/(:num)'] = 'fornecedor/delete/$1';
$route['listar_pecas'] = 'estoque/listar_pecas';
$route['salvar_nova_peca'] = 'estoque/salvar_peca';
